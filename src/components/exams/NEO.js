...
import "../../css/exams/NEO.css";
import Header from "../../components/tools/Header";
import Navbars from "../../components/tools/Navbars";
import ExamPhoto from "../../images/2.jpg";
...
import { NeoTitle } from "../tools/Constant";
import { NavLink } from "react-router-dom";
import AuthContext from "../../Context/Auth/authContext";

const NEO = () => {
  document.title = NeoTitle;
  // import AuthContext from "../../Context/Auth/authContext";
      ...
      {loading ? (
        ...
        <div id="NEO">
          ...
          <div className="aboutExam">
            <div className="examInfo">
              ...
              <div className="examphares">
                <h1>تست شخصیت شناسی NEO </h1>
                <p>
                  تست نئو به ارزیابی شخصیت می پردازد. در این آزمون 5 عامل اصلی
                  شخصیت و 30 شاخص فرعی سنجیده می شود.این آزمون به شما کمک می کند
                  که جنبه های متفاوت شخصیتی خود را کشف کرده و در جهت اعتلای
                  شخصیت خود گام بردارید.
                </p>
            ...
            <div className="examBtn">
              <NavLink to={user ? "/Question4" : "/Login"}>
          ...
          <div className="examRoll">
            <div className="rolls">
              <table style={{ backgroundColor: "#B4ECE3" }}>
                <tr>
                  <th>
