  ...
  return (
    <div id="NameQ4">
      ...
      {Charthide ? (
        ...
        //   //calscoreoftest5Data={calscoreoftest5Data}
        //   // maxSeriesData={maxSeriesData}
        //   //minSeriesData={minSeriesData}
        //   // userScorePercentSeriesData={userScorePercentSeriesData}
        //   // userFinalNumber={userFinalNumber}
        //   // userFinalCode={userFinalCode}
        //   // FinalResultDisc={FinalResultDisc}
        //   // KartableColumnsForAdmin={KartableColumnsForAdmin}
        //   // pdfFile={pdfFile}
        //   Charthide={Charthide}
        // />
        <Resultexam Charthide={Charthide} />
      ) : null}
    </div>
  );
};
