...
const NameQ6 = (props) => {
  ...
  //     //
  //     setFinalResultData(calscoreoftest117Data.CritriaScores);
  //     if (calscoreoftest117Data.CritriaScores) {
  //       if (calscoreoftest117Data.CritriaScores[0]) {
  //         setMath(calscoreoftest117Data.CritriaScores[0].MathScore);
  //         setExperimental(calscoreoftest117Data.CritriaScores[0].HealthScore);
  //         setHuman(calscoreoftest117Data.CritriaScores[0].HumanScore);
  //         setService(calscoreoftest117Data.CritriaScores[0].ServiceScore);
  //         setIndustry(calscoreoftest117Data.CritriaScores[0].IndustryScore);
  //         setAgriculture(
  //           calscoreoftest117Data.CritriaScores[0].AgricultureScore
  //         );
  //         setTechnical(calscoreoftest117Data.CritriaScores[0].TechnicalScore);
  //         setBussiness(calscoreoftest117Data.CritriaScores[0].BussinessScore);
  //       }
  //     }
  //   }
  // }, [calscoreoftest117Data]);
