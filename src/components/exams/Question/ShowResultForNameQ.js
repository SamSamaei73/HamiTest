...
const ShowResultForNameQ = React.forwardRef((props, ref) => {
  ...
  useEffectSkipFirst(() => {
    if (calscoreoftestJustForShowResultData) {
      console.log(
        "calscoreoftestJustForShowResultData:",
        calscoreoftestJustForShowResultData.userInfo
      );
      console.log(
        "calscoreoftestJustForShowResultData.CritriaScores:",
        calscoreoftestJustForShowResultData.CritriaScores
      );
      console.log(
        "calscoreoftestJustForShowResultData.userPattern:",
        calscoreoftestJustForShowResultData.userPattern
      );
