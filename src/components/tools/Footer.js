  ...
  return (
    <div id="Footer">
      <div className="styleFooter">
        <div className="certificate">
          ...
          >
            ...
            {/* <a referrerpolicy="origin" target="_blank" href="https://trustseal.enamad.ir/?id=287609&amp;Code=W5Ejk7KdGFvNSHionRgZ"><img referrerpolicy="origin" src={"https://Trustseal.eNamad.ir/logo.aspx?id=287609&amp;Code=W5Ejk7KdGFvNSHionRgZ"} alt="logo" style={{cursor:'pointer'}} id="W5Ejk7KdGFvNSHionRgZ"/></a> */}
          </a>
        </div>
      ...
      <footer>
        ...
        <p>
          Tamplate by <a href="https://alireza-samaei.com/"> Samaei Groups</a>
        </p>
      </footer>
    </div>
  );
